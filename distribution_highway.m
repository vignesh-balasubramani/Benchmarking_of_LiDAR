function Distribution=distribution_highway(x,b,dim0,dim1,loc,scenario)
...
%         max_density: maximum Horizontal density required (degree/rays)
%         min_density: minimum Horizontal density required (degree/rays)
...
%         vt_min_range (m)
    ...
    batch1=abs(ang(1:3,:)); %first 3 cases, mimimum most position
    batch2=abs(ang(4:6,:)); %last 3 cases, maximum most position
